  ...
  <div class="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
    <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
      <div class="col-span-2">
        <a href="/" aria-label="Go home" title="Company" class="inline-flex flex-col items-center w-full md:flex-row">
      ...
      <div class="col-span-2 space-y-2 text-sm md:col-span-1">
        ...
        <div class="flex">
          ...
          <a href="{{ $company->alamat }}" target="_blank" rel="noopener noreferrer" aria-label="Our address" title="Our address" class="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">
            {{ $company->alamat }}
          </a>
        </div>
      </div>
      ...
      <div class="col-span-2">
        <div class="maps">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15811.068372318428!2d110.90743211330285!3d-7.814461041927182!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a2e360ee9490b%3A0xf04efdd3ce153d1!2sAlun%20Alun%20Giri%20Krida%20Bakti!5e0!3m2!1sid!2sid!4v1715357693645!5m2!1sid!2sid" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
      </div>
    </div>
